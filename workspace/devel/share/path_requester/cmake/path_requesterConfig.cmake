  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'path_requester' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'agustin <agustin@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'path_requester' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/agustin/Agustin/Work/Ekumen/Localwork/ros_turtle/workspace/src/path_requester/${idir}'.  Ask the maintainer 'agustin <agustin@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/agustin/Agustin/Work/Ekumen/Localwork/ros_turtle/workspace/devel/lib;/home/agustin/catkin_ws/devel/lib;/opt/ros/indigo/lib)
...
set(path_requester_EXPORTED_TARGETS "")
